...
// 策划案申请
export const serviceapi = (params) => ajax(URL + 'action/serviceapi/apply',params,'POST')
// 策划案申请数据
export const serviceGetapply = (params) => ajax(URL + 'action/serviceapi/getapply',params)
// 个人中心功能限制
...
// 获取用户数据  能更改
export const selfDetail = (params) => ajax(URL + 'action/userapi/self',params)
// 保存用户信息
